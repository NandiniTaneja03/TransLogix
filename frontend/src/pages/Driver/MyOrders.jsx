...
setAvailableOrders(prev => prev.filter(o => o._id !== orderId));
  ...
  const handleVerifyOTP = () => {
    ...
    const updatedAccepted = driverAccepted.filter(o => o.id !== selectedOrder._id);
    ...
    const updatedVendorOrders = vendorOrders.map(o => 
      o.id === selectedOrder._id ? completedOrder : o
    );
      ...
      <div className="main-content">
        ...
        <div className="page-content">
          ...
          <div className="orders-grid">
            {orders.map((order) => (
              <div key={order._id} className={`order-card ${order.priority}`}>
                ...
                <div className="order-route">
                  <div className="route-point pickup">
                    ...
                    <div>
                      ...
                      <span className="route-address">{order.address}</span>
                    </div>
                  </div>
