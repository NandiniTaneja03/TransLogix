...
<div className="hero-image">
  ...
  <div className="hero-illustration">
    ...
    <div className="delivery-card">
      <span className="card-title">Live Delivery</span>
      <p>Order #ORD1023</p>
...
<line x1="150" y1="150" x2="260" y2="220"
stroke="#6366f1"
strokeWidth="2"
strokeDasharray="4,6"/>

<line x1="260" y1="220" x2="380" y2="180"
stroke="#6366f1"
strokeWidth="2"
strokeDasharray="4,6"/>

<line x1="260" y1="220" x2="320" y2="340"
stroke="#6366f1"
strokeWidth="2"
strokeDasharray="4,6"/>

<line x1="380" y1="180" x2="450" y2="260"
stroke="#6366f1"
strokeWidth="2"
strokeDasharray="4,6"/>
...
path="M150 150 L260 220 L380 180 L450 260"
/>
      ...
      <g className="truck-animation">
        ...
        <path d="M272.5 312 L272.5 332 M262 317 L283 317"
          stroke="#6366f1"
          strokeWidth="2"
          strokeLinecap="round"/>
      </g>
      ...
      <g className="pin-animation-1">
        ...
        <path
          d="M180 185 C170 185 165 195 165 200 C165 210 180 220 180 220 C180 220 195 210 195 200 C195 195 190 185 180 185 Z"
          fill="#22c55e"
        />
        ...
        {/* PICKUP TEXT */}
        <text x="150" y="170" fill="#22c55e" fontSize="14" fontWeight="600">
          Pickup
        </text>
      </g>
      ...
      <g className="pin-animation-2">
        ...
        <path
          d="M420 225 C410 225 405 235 405 240 C405 250 420 260 420 260 C420 260 435 250 435 240 C435 235 430 225 420 225 Z"
          fill="#6366f1"
        />
        ...
        {/* DELIVERY TEXT */}
        <text x="395" y="210" fill="#6366f1" fontSize="14" fontWeight="600">
          Delivery
        </text>
      </g>
      ...
      {/* ROUTE */}
      <path
        d="M180 200 Q250 220 300 240 T420 240"
        stroke="#6366f1"
        strokeWidth="3"
...
<circle r="6" fill="#22c55e">
  <animateMotion
    dur="4s"
    repeatCount="indefinite"
    path="M180 200 Q250 220 300 240 T420 240"
  />
</circle>
      {/* GRADIENTS */}
      <defs>
